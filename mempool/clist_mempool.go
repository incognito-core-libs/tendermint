...
import (
	...
	abci "github.com/incognito-core-libs/tendermint/abci/types"
	cfg "github.com/incognito-core-libs/tendermint/config"
	auto "github.com/incognito-core-libs/tendermint/libs/autofile"
	"github.com/incognito-core-libs/tendermint/libs/clist"
	cmn "github.com/incognito-core-libs/tendermint/libs/common"
	"github.com/incognito-core-libs/tendermint/libs/log"
	"github.com/incognito-core-libs/tendermint/proxy"
...
func (mem *CListMempool) Update(
	...
	for i, tx := range txs {
		...
		// Mempool after:
		//   100
		// https://github.com/incognito-core-libs/tendermint/issues/3322.
		if e, ok := mem.txsMap.Load(txKey(tx)); ok {
